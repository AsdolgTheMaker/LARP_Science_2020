...
namespace LARP.Science.Database
{
    ...
    public static class Controller
    {
        ...
        public static void CreateTestDatabase()
        {
            ...
            tempContainer.InstallAugmentToOrganSlot(new Augment("Процессор Intel Core i9 серии X", Character.BodyPartSlot.SlotType.Brain, ""));
            tempContainer.InstallAugmentToOrganSlot(new Augment("Мифриловое покрытие", Character.BodyPartSlot.SlotType.Body, ""));
            tempContainer.InstallAugmentToOrganSlot(new Augment("Гидравлический пресс «ORA-HAN-D»", Character.BodyPartSlot.SlotType.LeftArm, ""));
            tempContainer.InstallAugmentToOrganSlot(new Augment("Отбойный молоток класса WK", Character.BodyPartSlot.SlotType.RightArm, ""));
            tempContainer.InstallAugmentToOrganSlot(new Augment("Валенок левый", Character.BodyPartSlot.SlotType.LeftLeg, ""));
            tempContainer.InstallAugmentToOrganSlot(new Augment("Костыль", Character.BodyPartSlot.SlotType.RightLeg, ""));
            tempContainer.InstallAugmentToOrganSlot(new Augment("Насос из колодца на даче", Character.BodyPartSlot.SlotType.Heart, ""));
            ...
            tempContainer.InstallAugmentToOrganSlot(new Augment("Неизвестно что это, но по документации должно быть здесь", Character.BodyPartSlot.SlotType.Spleen, ""));
            tempContainer.InstallAugmentToOrganSlot(new Augment("Печень, распечатанная на 3D-принтере", Character.BodyPartSlot.SlotType.Liver, ""));
            tempContainer.InstallAugmentToOrganSlot(new Augment("Топливный бак от девятки", Character.BodyPartSlot.SlotType.Stomach, ""));
            tempContainer.InstallAugmentToOrganSlot(new Augment("Водопроводная система из сантехнического ларька", Character.BodyPartSlot.SlotType.Intestines, ""));
            tempContainer.InstallAugmentToOrganSlot(new Augment("Почки от дуба", Character.BodyPartSlot.SlotType.Kidneys, ""));
            tempContainer.InstallAugmentToOrganSlot(new Augment("Пылевой мешок от пылесоса", Character.BodyPartSlot.SlotType.Bladder, ""));
            tempContainer.InstallAugmentToOrganSlot(new Augment("Система клонирвоания Grineer", Character.BodyPartSlot.SlotType.Reproduction, ""));
        }
        #endif
    }
}